# <img src="./utils/media/azure_logo.png" alt="Azure Foundry" style="width:80px;height:30px;"/> Semantic Kernel Agent Orchestrator using MCP Tools via Azure API Management
